...
public class SysTriangInf extends SysLin{
	...
	public SysTriangInf(Matrice matriceSystem, MVecteur secondMembre) {
	...
	public static void main(String []args){
		...
		SysTriangInf sysTInf = new SysTriangInf(m1, x1);
		try {
			System.out.println(sysTInf.resolution().toString());
