...
public class SysTriangSup extends SysLin {
	...
	public SysTriangSup(Matrice matriceSystem, MVecteur secondMembre) {
	...
	public MVecteur resolution() throws IrregularSysLinException {
		...
		for(int i=n-1;i>=0;i--){
			...
			mvec.setCoef(i, (secondMembre.getCoef(i)-somme)/matriceSystem.getCoef(i,i) );
		}
		return mvec;
	}
	public static void main(String []args){
		MVecteur x1 = new MVecteur("vec1.txt");
		double [][] tab={{9,8,7},{0,6,5},{0,0,4}};
		...
		SysTriangSup sysTSup = new SysTriangSup(m1, x1);
		try {
			System.out.println(sysTSup.resolution().toString());
